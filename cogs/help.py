...
class Help(commands.Cog):
    ...
    async def help(self, ctx, *input):
        ...
        version = config["bot_version"] # enter version of your code
        ...
        if not input:
            ...
            emb.add_field(name="About", value=f"Made by FLOWER lovers, for FLOWER lovers.\n\
                                    Prefix is '{prefix}' \n\
                    ...
                    for command in self.bot.get_cog(cog).walk_commands():
                        ...
                        if not command.hidden:
                            if command.parent != None:
                                emb.add_field(name=f"`{prefix}{command.parent.name} {command.name}`", value=command.help, inline=False)
                            else:
